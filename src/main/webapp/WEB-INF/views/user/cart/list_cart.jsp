...
<body>
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				<li><a href="/MobileShop">Trang chủ</a> <span class="divider">/</span></li>
				<li class="active">Giỏ hàng</li>
			</ul>
			<div class="well well-small">
				<h1>
					Giỏ hàng <small class="pull-right"> ${ TotalQuantyCart } sản phẩm trong giỏ hàng
					</small>
				</h1>
				<hr class="soften" />
				...
				<a href="/MobileShop" class="shopBtn btn-large"><span
					class="icon-arrow-left"></span> Tiếp tục mua sắm </a> <a
					href="/MobileShop/checkout" class="shopBtn btn-large pull-right">Thanh toán <span
