	...
	<div class="row">
		<div class="span4">
			...
			<form:form action="dang-ky" method="POST" modelAttribute="user">
			  ...
			  <div class="control-group">
				<label class="control-label" for="inputEmail">Lò và Name</label>
				<div class="controls">
				  <form:input type="text" class="span3" placeholder="Fullname" path="display_name" />
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputEmail">Số điện thoại</label>
				<div class="controls">
				  <form:input type="text" class="span3" placeholder="Your number phone" path="number_phone" />
				</div>
			  </div>
			  <div class="control-group">
