...
<!-- font awesome styles -->
<link href="<c:url value="/assets/user/font-awesome.css" />"
	rel="stylesheet">
			...
			<div class="container">
				<div class="alignR">
					<div class="pull-left socialNw">
						...
						<a href="https://www.facebook.com/dangduong0127"><span
							class="icon-facebook"></span></a> <a
							href="https://www.youtube.com/channel/UC7hClxCjYxoUqI334g1Rs7Q"><span
							class="icon-youtube"></span></a> <a
							href="https://tinder.com/@dangduong0988"><span
							class="icon-tumblr"></span></a>
					</div>
					<a class="active" href="/MobileShop"> <span class="icon-home"></span>
						Trang chủ
					</a>
